...
public final class CodeUtil {
	 ...
	 * 验证码字体
	 */
	private static Font[] codeFont = { new Font("Times New Roman", Font.PLAIN, 30), new Font("Times New Roman", Font.PLAIN, 30), new Font("Times New Roman", Font.PLAIN, 30), new Font("Times New Roman", Font.PLAIN, 30) };
	 ...
	 */
	private static final String IMAGE_CHAR = "ABCDEFGHIJKLMNOPQRSTUVWXYZ" + "abcdefghijkmnpqrstuvwxyz23456789";
	...
	* 覆写doGet方法，完成验证码的生成
	*/
	public static void drawCode(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
