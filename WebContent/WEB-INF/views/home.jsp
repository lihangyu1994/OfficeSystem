		...
		<div class="hero-unit well"
			...
			<p>
				<a class="btn btn-primary btn-large"
					href="<%=basePath%>article/toAdd">撰写新公文</a>
			</p>
		</div>
	</section>
	...
	<section class="panel panel-default"
		...
		<div class="row m-l-none m-r-none bg-light lter">
			...
			<div class="col-sm-6 col-md-3 padder-v b-r b-light">
				...
				</span> <small class="text-muted text-uc">收到</small>
				</a>
			</div>
			...
			<c:if
				...
				<div class="col-sm-6 col-md-3 padder-v b-r b-light">
					...
					</span> <small class="text-muted text-uc">待处理</small>
					</a>
				</div>
			</c:if>
			...
			<div class="col-sm-6 col-md-3 padder-v b-r b-light">
				...
				</span> <small class="text-muted text-uc">被驳回</small>
				</a>
			</div>
			...
			<div class="col-sm-6 col-md-3 padder-v b-r b-light">
				...
				</span> <small class="text-muted text-uc">审核中</small>
				</a>
			</div>
		</div>
	</section>
		...
		<section class="panel bg-dark">
			<div class="carousel slide carousel-fade panel-body" id="c-fade">
				...
				<div class="carousel-inner">
					<div class="item active">
						<p class="text-center">
							<em class="h4 text-mute">公文处理流程</em><br> <small
								class="text-muted">下面来简单介绍一下系统中的公文处理流程。</small>
						</p>
					</div>
					<div class="item">
						<p class="text-center">
							<em class="h4 text-mute">Step 1:公文撰稿</em><br> <small
								class="text-muted">通过向导，您可以快速上传一篇公文来完成公文撰稿！</small>
						</p>
					</div>
					<div class="item">
						<p class="text-center">
							<em class="h4 text-mute">Step 2:公文提交</em><br> <small
								class="text-muted">撰稿完成后您可以提交公文，提交后公文将进入审核阶段。</small>
						</p>
					</div>
					<div class="item">
						<p class="text-center">
							<em class="h4 text-mute">Step 3:公文审核</em><br> <small
								class="text-muted">如果您是审核人员，您可以审核用户上传的公文。否则，您需要耐心等待审核结果。</small>
						</p>
					</div>
					<div class="item">
						<p class="text-center">
							<em class="h4 text-mute">Step 4:公文发布</em><br> <small
								class="text-muted">审核通过的公文将被发布，目标用户将会收到公文。</small>
						</p>
					</div>
					<div class="item">
						<p class="text-center">
							<em class="h4 text-mute">FAQ:我的公文被驳回怎么办？</em><br> <small
								class="text-muted">审核不通过的公文会被驳回，您可以修改或删除被驳回的公文。</small>
						</p>
					</div>
				</div>
